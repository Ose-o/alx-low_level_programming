 ...
 * @e_ident:This is a pointer to an array containing the ELF magic numbers.
 *
 * Description: The Magic numbers are separated by spaces between them.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: This is a pointer to an array containing an ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
 ...
 * @e_ident: the is a pointer to an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * close_elf - This will Closes an ELF file.
 ...
 * @argc: Tells the number of arguments supplied to the program.
 * @argv: This is an array of pointers to the arguments.
 *
 * Return: 0 on success.
 *
 * Description: If the file is not same as an ELF File or
