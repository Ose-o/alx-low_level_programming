 ...
 * @file: Buffer stores chars for the program.
 * Author: Ose Oriabure
 ...
 * @fd: The file descriptor to closee.
 */
void close_file(int fd)
{
	int c;
...
/**
 * main - These are contents of a file to another file.
 * @argc: These are arguments supplied to the program.
 * @argv: These are array of pointers to the arguments.
 *
